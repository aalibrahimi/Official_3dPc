  ...
  return (
    <div className="space-y-3 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
      {parts.map((part) => (
        <Card
          key={part.id}
          className={`transition-all duration-300 hover:shadow-lg bg-black hover:shadow-blue-500/20 cursor-pointer border ${
        ...
        >
          <CardContent className="p-3 flex items-center gap-3 ">
            ...
            <div className="flex flex-col items-end gap-2">
              <Badge className="bg-blue-950/1 text-blue-500 outline">
                ${part.specs}
              </Badge>
