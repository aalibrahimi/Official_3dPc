...
export default function FeaturesSection() {
  return (
    <section className="mt-95 py-16 md:py-32">
              ...
              <CardContent className="pt-6">
                ...
                <div className="relative z-10 mt-6 space-y-2 text-center">
                  ...
                  <p className="text-foreground">
                    All components are tested for compatibility and performance
                    guarantees.
                  </p>
                </div>
              </CardContent>
            ...
            <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-green-950">
              <CardContent className="pt-6">
                ...
                <div className="relative z-10 mt-14 space-y-2 text-center">
                  ...
                  <p className="text-foreground">
                    Get instant feedback on your build's estimated performance
              ...
              <CardContent className="grid pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-foreground">
                      Extended warranty coverage and 24/7 technical support for
                      all components.
                    </p>
                  </div>
                </div>
                ...
                <div className="rounded-tl-(--radius) border-white bg-black relative -mb-6 -mr-6 mt-6 h-fit border-l border-t p-6 py-6 sm:ml-6">
                  <div className="absolute left-3 top-2 flex gap-1">
                    ...
                    <span className="block size-2 rounded-full border border-white/10 bg-blue-400"></span>
                  </div>
                  <svg
              ...
              <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-foreground">
                      Real-time price tracking across multiple retailers for the
                ...
                <div className="before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                  <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                    <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                      <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm bg-green-500">
                        Amazon
                      </span>
                      <div className="ring-background size-7 ring-4">
                        <span className="flex h-full w-full items-center justify-center text-xs font-bold bg-blue-800">
                          -10%
                        </span>
                      </div>
                    </div>
                    <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2 ">
                      ...
                      <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm bg-orange-500">
                        Newegg
                      </span>
                    </div>
                    <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                      <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm bg-indigo-950">
                        Microcenter
                      </span>
                      <div className="ring-background size-7 ring-4">
                        <span className="flex h-full w-full items-center justify-center text-xs font-bold bg-blue-800">
