            ...
            <div className="mx-auto max-w-5xl px-6">
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        {/* First Card - 100% Compatible */}
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 bg-pink-950">
                            <CardContent className="relative m-auto size-fit pt-6">
                                ...
                                <h2 className="mt-6 text-center text-3xl font-semibold">Compatible</h2>
                            </CardContent>
                        </Card>

                        {/* Second Card - Verified Components */}
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-blue-950">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                    <Cpu className="m-auto h-16 w-16" strokeWidth={1} />
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="group-hover:text-secondary-950 text-lg font-medium transition dark:text-white">Verified Components</h2>
                                    <p className="text-foreground">All components are tested for compatibility and performance guarantees.</p>
                                </div>
                            </CardContent>
                        </Card>

                        {/* Third Card - Performance Metrics */}
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-green-950">
                            <CardContent className="pt-6">
                                <div className="pt-6 lg:px-6">
                                    <svg className="dark:text-muted-foreground w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <g clipPath="url(#clip0_0_106)">
                                            ...
                                            <text x="55" y="32" fill="currentColor" fontFamily="Arial" fontSize="16">Performance Score</text>
                                            <text x="250" y="32" fill="currentColor" fontFamily="Arial" fontSize="20" fontWeight="bold">98.6%</text>
                                        </g>
                                        <path
                                            fillRule="evenodd"
                                            clipRule="evenodd"
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="text-lg font-medium transition">Real-time Performance</h2>
                                    <p className="text-foreground">Get instant feedback on your build's estimated performance across games and applications.</p>
                                </div>
                            </CardContent>
                        </Card>

                        {/* Fourth Card - Warranty Protection */}
                        <Card className="card variant-outlined relative col-span-full overflow-hidden lg:col-span-3 bg-purple-950">
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="group-hover:text-secondary-950 text-lg font-medium text-zinc-800 transition dark:text-white">Warranty Protection</h2>
                        ...
                        {/* Fifth Card - Price Comparison */}
                        <Card className="card variant-outlined relative col-span-full overflow-hidden lg:col-span-3 bg-rose-950">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                        <DollarSign className="m-auto size-6" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium transition">Price Comparison</h2>
                                        <p className="text-foreground">Real-time price tracking across multiple retailers for the best deals on components.</p>
                                    </div>
                                </div>
                                <div className="before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm bg-green-500">Amazon</span>
                                            <div className="ring-background size-7 ring-4">
                                                <span className="flex h-full w-full items-center justify-center text-xs font-bold bg-red-800">-10%</span>
                                            </div>
                                        </div>
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2 ">
                                            <div className="ring-background size-8 ring-4 ">
                                                <span className="flex h-full w-full items-center justify-center text-xs font-bold bg-red-800">-15%</span>
                                            </div>
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm bg-orange-500">Newegg</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm bg-indigo-950">Microcenter</span>
                                            <div className="ring-background size-7 ring-4">
                                                <span className="flex h-full w-full items-center justify-center text-xs font-bold bg-red-800">-5%</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
