...
const testimonials: Testimonial[] = [
  {
    ...
    quote:
      "Hasan is really extraordinary and very practical, no need to break your head. A real gold mine.",
  },
  {
    name: "Yves Kalume",
    role: "GDE - Android",
    ...
    quote:
      "With no experience in webdesign I just blueesigned my entire website in a few minutes with tailwindcss thanks to Hasan.",
  },
  {
  ...
  },
  {
    ...
    quote:
      "Hasan is blueefining the standard of web design, with these blocks it provides an easy and efficient way for those who love beauty but may lack the time to implement it. I can only recommend this incblueible wonder.",
  },
  {
    name: "Hanif",
  ...
  },
  {
    ...
    quote:
      "I love Hasan ❤️. The component blocks are well-structublue, simple to use, and beautifully designed. It makes it really easy to have a good-looking website in no time.",
  },
  {
    name: "Eric Ampire",
...
export default function AboutPage() {
  return (
    <div className="bg-gradient-to-b from-black via-black to-blue-950/60">
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              The visionary behind PCPartPicker's revolutionary 3D part
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
            <motion.div
              ...
              className="group"
            >
              <Card className="bg-black/40 border-blue-950/20 hover:border-blue-500/50 transition-all duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-400 text-sm">
                    Making PC building accessible and intuitive for everyone
            ...
            >
              <Card className="bg-black/40 border-blue-950/20 hover:border-blue-500/50 transition-all duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-400 text-sm">
                    Pioneering 3D visualization to eliminate compatibility
                    guesswork
                  </p>
                </CardContent>
              </Card>
            ...
            >
              <Card className="bg-black/40 border-blue-950/20 hover:border-blue-500/50 transition-all duration-300">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-400 text-sm">
                    Creating an immersive journey that educates while it
                    entertains
                  </p>
                </CardContent>
              </Card>
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-gray-300 leading-relaxed">
                As someone who's built countless PCs, I experienced firsthand
                the frustration of compatibility issues and the anxiety of not
                knowing if parts would fit. That's why I created PCPartPicker's
                3D visualization system - to transform this process from
                guesswork into an interactive, educational experience.
              </p>
              <p className="text-gray-300 leading-relaxed">
                Our 3D part picker uses advanced Three.js rendering to create
                realistic, interactive components that you can preview before
                purchasing. Each part animates into place, giving you confidence
                in your build before spending a single dollar.
              </p>
            </div>
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500/20 to-blue-900/20 rounded-3xl blur-3xl" />
              <Card className="relative bg-black/40 border-blue-950/20 overflow-hidden">
                <CardContent className="p-8">
                  <div className="aspect-video bg-gradient-to-br from-blue-500/10 to-blue-900/10 rounded-lg flex items-center justify-center">
          ...
          >
            ...
            <p className="text-gray-300 max-w-3xl mx-auto mb-8">
              This project wouldn't be possible without the incblueible team at
              CodeWithAli and our community of developers who contributed to
              making this vision a reality. Special thanks to our lead
              developers, 3D artists, and UI/UX designers who pushed the
              boundaries of what's possible in web-based PC building tools.
            </p>
            <div className="flex justify-center gap-4">
              <span className="px-4 py-2 bg-blue-500/10 rounded-full text-blue-500 text-sm">
                10+ Contributors
              </span>
              <span className="px-4 py-2 bg-blue-500/10 rounded-full text-blue-500 text-sm">
                1000+ Hours
              ...
              {testimonialChunks.map((chunk, chunkIndex) => (
                <div key={chunkIndex} className="space-y-3 ">
                  {chunk.map(({ name, role, quote, image }, index) => (
                    <Card key={index} className="bg-black border-blue-950">
