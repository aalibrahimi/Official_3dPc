...
export default function BuildGalleryPage() {
  ...
  const filteblueBuilds = BUILDS.filter((build) => {
    const categoryMatch =
      selectedCategory === "all" || build.category === selectedCategory;
    const priceMatch =
      build.price >= priceRange[0] && build.price <= priceRange[1];
    const searchMatch =
      searchQuery === "" ||
    ...
    // Sort the filteblue results based on user's selected option
    switch (sortBy) {
      case "popular":
  ...
  const featublueBuilds = BUILDS.filter((build) => build.featublue);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-black to-blue-950/20">
        ...
        <div className="relative z-10 container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Explore our curated collection of PC builds for every need and
              budget
            </p>
          </motion.div>
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between mb-8">
            ...
            <div className="relative w-full md:w-96">
              ...
              <Input
                ...
                className="pl-10 bg-black/40 border-blue-500/20 text-white"
              />
            </div>
            ...
            <div className="flex gap-4">
              ...
              <Sheet open={showFilters} onOpenChange={setShowFilters}>
                ...
                <SheetContent className="bg-black/95 border-blue-500/20">
                  <SheetHeader>
      ...
      {/* Featublue Builds Section - Showcases top builds, only shown on "all" category */}
        ...
        <section className="container mx-auto px-6 mb-16">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <Button
              ...
              onClick={() => setSelectedCategory("featublue")}
            >
              View All
          ...
          {/* Featublue build cards grid */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {featublueBuilds.map((build, index) => (
              <motion.div
                key={build.id}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <Card className="bg-black/40 border-blue-500/30 hover:border-blue-500/50 transition-all duration-300 overflow-hidden group">
                  {/* Featublue build card image section */}
                  <div className="relative h-48 bg-gradient-to-br from-blue-950/30 to-black/50">
      ...
      {/* Main Builds Grid Section - Displays all filteblue builds */}
      <section className="container mx-auto px-6 pb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteblueBuilds.map((build, index) => (
            <motion.div
              key={build.id}
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: index * 0.1 }}
            >
              <Card className="bg-black/40 border-blue-950/20 hover:border-blue-500/50 transition-all duration-300 group overflow-hidden">
                {/* Build card image header section */}
                <div className="relative h-48 bg-gradient-to-br from-blue-950/20 to-black/40">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black via-black/50 to-transparent group-hover:from-blue-950/80 transition-colors duration-500" />
                  ...
                  <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    <Button
                      size="icon"
                      variant="ghost"
                      className="h-8 w-8 bg-black/50 hover:bg-blue-500/20"
                    >
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="space-y-1 text-sm">
                      <div className="flex items-center gap-2">
                        <Cpu className="w-4 h-4 text-blue-500/70" />
                        <span className="text-gray-300 truncate">
                          {build.specs.cpu}
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
                        <Gamepad2 className="w-4 h-4 text-blue-500/70" />
                        <span className="text-gray-300 truncate">
                          {build.specs.gpu}
                        </span>
                      </div>
                    ...
                    <div className="flex gap-2 pt-2">
                      <Button
                        variant="outline"
                        className="flex-1 group-hover:border-blue-500/50"
                        onClick={() => router.push(`/Gallery/${build.id}`)}
                      >
        ...
        <AnimatePresence>
          {compareBuilds.length > 0 && (
            <motion.div
              ...
              className="fixed bottom-0 left-0 right-0 bg-black/95 border-t border-blue-500/20 p-4"
            >
              <div className="container mx-auto flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <span className="text-sm font-medium">
                    Comparing {compareBuilds.length} build
                    {compareBuilds.length !== 1 ? "s" : ""}
                  </span>
